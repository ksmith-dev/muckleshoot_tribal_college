...
<div class="container-fluid">
    ...
    <div id="edit-container" class="row">
        <div class="col-xs-12">
            <form action="{{@BASE}}/Admin/add-partner" method="post" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group paragraph">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="partner title text">
                </div>
                <div class="form-group paragraph">
                    <label for="sub-title">Partner Sub-title:</label>
                    <input type="text" class="form-control" id="sub-title" name="sub-title" placeholder="partner sub-title text">
                </div>
                <div class="form-group paragraph">
                ...
                <div class="form-group list-tool">
                    ...
                    <textarea rows="8"  type="text" class="form-control" id="info-list-data" name="info-list-data" placeholder="list data"></textarea>
                </div>
                <div class="form-group paragraph">
                ...
                <div class="form-group contact">
                    ...
                    <input type="text" class="form-control" id="contact-name" name="contact-name" placeholder="contact's full name">
                </div>
                <div class="form-group contact">
                ...
                <div class="form-group contact">
                    ...
                    <input type="text" class="form-control" id="contact-desc" name="contact-desc" placeholder="contact's description text">
                </div>
                <div class="form-group contact">
