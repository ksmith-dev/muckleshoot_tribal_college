<div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="col-sm-offset-1 col-sm-5" id="applyMessage">
                    <h2>Welcome to Muckleshoot Tribal College</h2>
                    <br>
                    <p>Admission to the college is open to anyone. Muckleshoot Tribal College welcomes people of all income levels,
                    backgrounds and previous educational experience.</p>
                    <br>
                    <p>Check your email within 2 days of applying for notification of your student identification number (SID) and follow instructions
                    for setting up your Muckleshoot Tribal College – issued student e-mail account.</p>
                    <br>
                    <br>

                </div>
                <div class="col-sm-5">
                    <div id="applyImg" class="col-sm-offset-1 col-sm-5">
                        <div class="col-sm-12">
                            <img id="applyImg" class="img-responsive" src="asset/img/apply.jpg" alt="Apply to Muckleshoot College" title="Apply to Muckleshoot College" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form col-sm-12">
                ...
                <form id="applyForm" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    <div id="applyNow" class="col-sm-offset-3 col-sm-6">                                        
                        ...
                        <div class="form-group">
                            ...
                            <div id="birthdate" class="col-sm-10">
                                    <select id="birthdate_m" class="btn btn-default" name="birthdate_m" size="1" required><option value=""></option><option value="01">January</option>
                                    <option value="02">February</option><option value="03">March</option><option value="04">April</option>
                                    <option value="05">May</option><option value="06">June</option><option value="07">July</option>
                                    <option value="08">August</option><option value="09">September</option><option value="10">October</option>
                                    <option value="11">November</option><option value="12">December</option></select>

                                    <select id="birthdate_d" class="btn btn-default" name="birthdate_d" size="1" required><option value=""></option><option value="01">1</option>
                                    <option value="02">2</option><option value="03">3</option><option value="04">4</option><option value="05">5</option>
                                    <option value="06">6</option><option value="07">7</option><option value="08">8</option><option value="09">9</option>
                                    ...
                                    <select id="birthdate_y" class="btn btn-default" name="birthdate_y" size="1" required><option></option><option value="2017">2017</option>
                    ...
                    <div class="col-sm-offset-6 col-sm-3">
                        <input class=" btn-lg" type="submit" value="Apply">
                    </div>
                </form>
            </div>
        </div>
